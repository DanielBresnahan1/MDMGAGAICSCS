...
"""@package docstring
Class for constructing a pipeline for generating a heatmap from an image, 
requires for 3 CNN models to be pretrained expecting input dimensions (None, 3, 224, 224)
Additionally, requires that map_patch be run prior to generate strided image patches for classification

"""

class HeatMaper:
    
    def __init__(self, images_dir: str, save_dir: str, 
                 patch_size: tuple, original_dir: str, modelA: str, modelB: str, modelC: str):
        """
        ...
        ----------
        images_dir : str
            system path to directory which contains strided images generated by map_patch.
            Directory format should be 
            Base:
            ->IMAGE_NAME
                ->Image_patch_X_Y_A.jpg
                ...
        save_dir : str
            System path to directory to save generated heat maps to. Will be of the form
            Base:
            ->Image_Patch_X_Y_A.jpg
        patch_size : tuple
            DESCRIPTION.
